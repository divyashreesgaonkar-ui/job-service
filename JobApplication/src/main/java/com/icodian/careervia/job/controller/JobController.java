...
public class JobController {
	...
	@GetMapping("/postedDate")
	public ResponseEntity<List<JobResponseDTO>> getJobsByPostedDate(@RequestParam("postedDate") LocalDate postedDate) {
		
		List<JobResponseDTO> jobs = jobService.getJobsByPostedDate(postedDate);
		return ResponseEntity.ok(jobs);
	}
